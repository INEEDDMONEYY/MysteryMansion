...
import { referralsPageData } from "../data/referralsPageData";
...
export default function ReferralHowItWorks() {
  const { howItWorks } = referralsPageData;
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-5">
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-pink-50 text-pink-600 transition-colors duration-300 group-hover:bg-pink-600 group-hover:text-white">
