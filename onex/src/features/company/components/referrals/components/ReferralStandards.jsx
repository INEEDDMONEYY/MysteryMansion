...
export default function ReferralStandards() {
  const { standards } = referralsPageData;
          ...
          >
            <div className="space-y-6">
              {standards.items.map((item, index) => (
                ...
                >
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-pink-50 text-pink-600">
