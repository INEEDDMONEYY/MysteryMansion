...
export default function ProviderFeatures() {
  const { features } = providerPageData;
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-pink-50 text-pink-600 transition-all duration-300 group-hover:bg-pink-600 group-hover:text-white">
                    <Icon className="h-5 w-5" />
                  </div>

                  <ArrowUpRight className="h-5 w-5 text-gray-300 transition-all duration-300 group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:text-pink-500" />
                </div>
