import { Bell, UserPlus, MessageSquare, TrendingUp, CheckCheck, RefreshCw } from 'lucide-react';
import { formatDistanceToNow } from 'date-fns';
import useNotifications from '@/shared/hooks/useNotifications';

const TYPE_META = {
  new_signup:         { icon: UserPlus,      color: 'text-emerald-400', bg: 'bg-emerald-400/10', label: 'New Sign Up'       },
  new_comment:        { icon: MessageSquare, color: 'text-blue-400',    bg: 'bg-blue-400/10',    label: 'New Comment'       },
  browse_peak:        { icon: TrendingUp,    color: 'text-pink-400',    bg: 'bg-pink-400/10',    label: 'Browse Peak'       },
  ...
  account_restricted: { icon: Bell,          color: 'text-red-400',     bg: 'bg-red-400/10',     label: 'Account Restricted'},
};
